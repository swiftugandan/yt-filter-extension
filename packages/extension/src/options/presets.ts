...
export const BUILTIN_PRESETS: Array<{
  ...
  },
  {
    id: "kid-safe",
    name: "Kid Safe",
    desc: "Make YouTube safer for children. Blocks violence, adult content, horror, drugs, profanity, and inappropriate material.",
    filters: {
      titleKeywords: [
        "18+",
        "nsfw",
      ...
      channelNames: [],
      titleRegex:
        "(\\b(sex|porn|xxx|nsfw|18\\+|kill(ing|ed|s)?|murder(ed|s)?|gore|torture[ds]?|massacre|nude|naked|weed|cocaine|heroin|meth|drunk|gambling|casino|jumpscare|serial\\s*killer|creepypasta)\\b|\\bgone\\s+sexual\\b)",
      hideShorts: true,
      hideLive: true,
      hideWatched: false,
      hideMixes: true,
...
function describeFilters(
  ...
  if (f.hideAdultContent)
    lines.push({ label: "Filtering", value: "Adult content" });
  return lines;
}
